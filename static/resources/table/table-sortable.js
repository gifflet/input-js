    ...
    _createClass(TableSortable, [{
        ...
        value: function generatePagination() {
            ...
            if (this.controlRow) {
                ...
                if (paginationContainer)
                    ...
                    $("#table-controls-paginate").append(this.controlRow);
            } else {
                if (paginationContainer)
        ...
        value: function constructTableCell() {
            ...
            var _config5 = this.config,
                ...
                hiddenColumns = _config5.hiddenColumns;
            ...
            forIn(columns, function (value, key, i) {
                ...
                if(hiddenColumns && hiddenColumns.includes(key)){
                    tbd = $('<th style="display:none;" class="noselect"></th>');
                }else{
                    tbd = $('<th class="noselect"></th>');
                }
            ...
            map(data.slice(this.leftBase, this.rightBase), function (row, i) {
                ...
                $(tbr).on("click", function () {
                    if ($(this).hasClass('selected-row')) {
                        ...
                        $(this).addClass('selected-row').siblings().removeClass(
                            'selected-row');
                        $(this).removeClass("row-hover");
                        selectedRowId = $(this).find('td:first').html();
                        $("#btnAtualizarAnamnese").prop("disabled", false);
                        $("#btnRemoverAnamnese").prop("disabled", false);
                    }
                });
                $(tbr).on("mouseover", function () {
                    if (!$(this).hasClass("selected-row")) {
                        $(this).addClass('row-hover');
                    }
                });
                $(tbr).on("mouseout", function () {
                    $(this).removeClass(
                        'row-hover');
                });                
